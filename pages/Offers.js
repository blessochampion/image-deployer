...
(() => {
  ...
  var SNIPPET_CODE_TO_HOTEL = {
    ...
    zzzzz25377: { destination: "ile Maurice", slug: "" },
    ...
    agstm21687: { destination: "Saint-Martin", slug: "" },
  ...
  var apiBaseUrl = "http://127.0.0.1:54399/";
  ...
  var Offers = class {
     ...
     */
    async getGroupOffers(locale = "fr_FR") {
  ...
  window.fsAttributes.push([
    "cmsfilter",
    async (filtersInstances2) => {
      const [filtersInstance] = filtersInstances2;
