...
(() => {
  ...
  var StartingPrice = class {
    constructor(container) {
      this.hotelsIds = [];
      this.itemElements = [];
      console.log(container.querySelectorAll(SELECTORS.beHid), "jd");
  ...
  window.fsAttributes.push([
    ...
    async (filtersInstances) => {
      ...
      const startingPrice = new StartingPrice(firstItem.element.parentElement);
      await startingPrice.getHotelStartingPrice();
    }
  ]);
})();
//# sourceMappingURL=Combines.js.map
